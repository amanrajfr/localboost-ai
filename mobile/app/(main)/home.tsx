...
export default function Home() {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <TouchableOpacity style={styles.actionCard} activeOpacity={0.8} onPress={() => router.push('/(main)/business')}>
                <View style={styles.actionIconCircle}>
                    <Text style={styles.actionEmoji}>📍</Text>
                </View>
                <View style={styles.actionTextContainer}>
                    <Text style={styles.actionTitle}>Business Profile</Text>
                    <Text style={styles.actionSubtitle}>Set up or edit your local business info</Text>
                </View>
                <Text style={styles.actionArrow}>→</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.actionCard} activeOpacity={0.8} onPress={() => router.push('/(main)/reviews')}>
                <View style={[styles.actionIconCircle, { backgroundColor: COLORS.accent + '15' }]}>
                    <Text style={styles.actionEmoji}>⭐</Text>
                </View>
                <View style={styles.actionTextContainer}>
                    <Text style={styles.actionTitle}>Review Dashboard</Text>
                    <Text style={styles.actionSubtitle}>Manage and AI-reply to reviews</Text>
                </View>
                <Text style={styles.actionArrow}>→</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.actionCard} activeOpacity={0.8} onPress={() => router.push('/(main)/insights')}>
                <View style={[styles.actionIconCircle, { backgroundColor: COLORS.success + '15' }]}>
                    <Text style={styles.actionEmoji}>📊</Text>
                </View>
                <View style={styles.actionTextContainer}>
                    <Text style={styles.actionTitle}>AI Insights</Text>
                    <Text style={styles.actionSubtitle}>View smart business analytics</Text>
                </View>
                <Text style={styles.actionArrow}>→</Text>
            </TouchableOpacity>
